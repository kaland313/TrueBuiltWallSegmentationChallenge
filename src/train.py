...
def main(cfg: DictConfig):
    ...
    train_dataset = SegmentationDataset(
        train_images, train_masks, train_transforms, num_classes=cfg.model.out_classes
    )
    val_dataset = SegmentationDataset(
        val_images, val_masks, val_transforms, num_classes=cfg.model.out_classes
    )
